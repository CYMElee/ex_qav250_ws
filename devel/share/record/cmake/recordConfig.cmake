...
if("TRUE" STREQUAL "TRUE")
  set(record_SOURCE_PREFIX /home/ubuntu/yajie_ws/ex_qav250_ws/src/record)
  set(record_DEVEL_PREFIX /home/ubuntu/yajie_ws/ex_qav250_ws/devel)
  set(record_INSTALL_PREFIX "")
  set(record_PREFIX ${record_DEVEL_PREFIX})
else()
  set(record_SOURCE_PREFIX "")
  set(record_DEVEL_PREFIX "")
  set(record_INSTALL_PREFIX /home/ubuntu/yajie_ws/ex_qav250_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'record' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/yajie_ws/ex_qav250_ws/src/record/${idir}'.  ${_report}")
    endif()
